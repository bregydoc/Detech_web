...
$packages["github.com/gopherjs/jquery"] = (function() {
	var $pkg = {}, $init, js, JQuery, JQueryCoordinates, Deferred, sliceType, funcType$1, mapType, sliceType$1, funcType$2, funcType$3, ptrType, sliceType$2, NewJQuery, Post;
	js = $packages["github.com/gopherjs/gopherjs/js"];
...
$packages["main"] = (function() {
	var $pkg = {}, $init, js, jquery, sliceType, mapType, funcType, funcType$1, ptrType, jQuery, showLoader, hideLoader, removePatient, main;
	js = $packages["github.com/gopherjs/gopherjs/js"];
	jquery = $packages["github.com/gopherjs/jquery"];
	sliceType = $sliceType($emptyInterface);
	mapType = $mapType($String, $String);
	funcType = $funcType([jquery.Deferred], [], false);
	...
	removePatient = function(dni) {
		var $ptr, _r, _r$1, dni, idOfUser, materialize, $s, $r;
		/* */ $s = 0; var $f, $c = false; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $ptr = $f.$ptr; _r = $f._r; _r$1 = $f._r$1; dni = $f.dni; idOfUser = $f.idOfUser; materialize = $f.materialize; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
		dni = [dni];
		materialize = [materialize];
		materialize[0] = $global.Materialize;
		_r = jQuery(new sliceType([new $String("#id_of_user")])); /* */ $s = 1; case 1: if($c) { $c = false; _r = _r.$blk(); } if (_r && _r.$blk !== undefined) { break s; }
		_r$1 = _r.Attr("class"); /* */ $s = 2; case 2: if($c) { $c = false; _r$1 = _r$1.$blk(); } if (_r$1 && _r$1.$blk !== undefined) { break s; }
		idOfUser = _r$1;
		$r = showLoader(); /* */ $s = 3; case 3: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
		jquery.Post(new sliceType([new $String("/api/patients/remove/"), new mapType($makeMap($String.keyFor, [{ k: "dni", v: dni[0] }, { k: "token", v: "99524c616bc275d72b28c97f6c61b21669100621" }, { k: "userId", v: idOfUser }]))])).Done(new sliceType([new funcType((function(dni, materialize) { return function $b(data) {
			var $ptr, _r$2, _r$3, data, $s, $r;
			/* */ $s = 0; var $f, $c = false; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $ptr = $f.$ptr; _r$2 = $f._r$2; _r$3 = $f._r$3; data = $f.data; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
			data = $clone(data, jquery.Deferred);
			materialize[0].toast($externalize("Usuario eliminado", $String), 5000, $externalize("", $String), $externalize((function(dni, materialize) { return function() {
				var $ptr;
			}; })(dni, materialize), funcType$1));
			_r$2 = jQuery(new sliceType([new $String("#element" + dni[0])])); /* */ $s = 1; case 1: if($c) { $c = false; _r$2 = _r$2.$blk(); } if (_r$2 && _r$2.$blk !== undefined) { break s; }
			_r$3 = _r$2.Remove(new sliceType([])); /* */ $s = 2; case 2: if($c) { $c = false; _r$3 = _r$3.$blk(); } if (_r$3 && _r$3.$blk !== undefined) { break s; }
			_r$3;
			$r = hideLoader(); /* */ $s = 3; case 3: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
			$s = -1; return;
			return;
			/* */ } return; } if ($f === undefined) { $f = { $blk: $b }; } $f.$ptr = $ptr; $f._r$2 = _r$2; $f._r$3 = _r$3; $f.data = data; $f.$s = $s; $f.$r = $r; return $f;
		}; })(dni, materialize))])).Fail(new sliceType([new funcType$1((function(dni, materialize) { return function() {
			var $ptr;
			materialize[0].toast($externalize("No se completo la operacion", $String), 5000, $externalize("", $String), $externalize((function(dni, materialize) { return function() {
				var $ptr;
			}; })(dni, materialize), funcType$1));
		}; })(dni, materialize))]));
		$s = -1; return;
		return;
		/* */ } return; } if ($f === undefined) { $f = { $blk: removePatient }; } $f.$ptr = $ptr; $f._r = _r; $f._r$1 = _r$1; $f.dni = dni; $f.idOfUser = idOfUser; $f.materialize = materialize; $f.$s = $s; $f.$r = $r; return $f;
	};
	main = function() {
		var $ptr, _r, _r$1, $s, $r;
		/* */ $s = 0; var $f, $c = false; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $ptr = $f.$ptr; _r = $f._r; _r$1 = $f._r$1; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
		...
		_r$1 = _r.Ready((function $b() {
			var $ptr, _r$1, _r$2, _r$3, _r$4, _r$5, _r$6, $s, $r;
			/* */ $s = 0; var $f, $c = false; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $ptr = $f.$ptr; _r$1 = $f._r$1; _r$2 = $f._r$2; _r$3 = $f._r$3; _r$4 = $f._r$4; _r$5 = $f._r$5; _r$6 = $f._r$6; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
			$r = hideLoader(); /* */ $s = 1; case 1: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
			_r$1 = jQuery(new sliceType([new $String(".button-collapse")])); /* */ $s = 2; case 2: if($c) { $c = false; _r$1 = _r$1.$blk(); } if (_r$1 && _r$1.$blk !== undefined) { break s; }
			_r$2 = _r$1.Call("sideNav", new sliceType([])); /* */ $s = 3; case 3: if($c) { $c = false; _r$2 = _r$2.$blk(); } if (_r$2 && _r$2.$blk !== undefined) { break s; }
			_r$2;
			_r$3 = jQuery(new sliceType([new $String(".deletePatient")])); /* */ $s = 4; case 4: if($c) { $c = false; _r$3 = _r$3.$blk(); } if (_r$3 && _r$3.$blk !== undefined) { break s; }
			_r$4 = _r$3.Each((function(index, btn) {
				var $ptr, btn, btnJs, index;
				btnJs = $assertType(btn, ptrType);
				btnJs.addEventListener($externalize("click", $String), $externalize((function() {
					var $ptr;
					$go((function $b() {
						var $ptr, dni, $s, $r;
						/* */ $s = 0; var $f, $c = false; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $ptr = $f.$ptr; dni = $f.dni; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
						dni = $substring($internalize(btnJs.id, $String), 6);
						$r = removePatient(dni); /* */ $s = 1; case 1: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
						$s = -1; return;
						return;
						/* */ } return; } if ($f === undefined) { $f = { $blk: $b }; } $f.$ptr = $ptr; $f.dni = dni; $f.$s = $s; $f.$r = $r; return $f;
					}), []);
				}), funcType$1));
			})); /* */ $s = 5; case 5: if($c) { $c = false; _r$4 = _r$4.$blk(); } if (_r$4 && _r$4.$blk !== undefined) { break s; }
			_r$4;
			_r$5 = jQuery(new sliceType([new $String(".detailsPatient")])); /* */ $s = 6; case 6: if($c) { $c = false; _r$5 = _r$5.$blk(); } if (_r$5 && _r$5.$blk !== undefined) { break s; }
			_r$6 = _r$5.Each((function(index, btn) {
				var $ptr, btn, btnJs, index;
				btnJs = $assertType(btn, ptrType);
				btnJs.addEventListener($externalize("click", $String), $externalize((function() {
					var $ptr;
			...
			})); /* */ $s = 7; case 7: if($c) { $c = false; _r$6 = _r$6.$blk(); } if (_r$6 && _r$6.$blk !== undefined) { break s; }
			_r$6;
			$s = -1; return;
			return;
			/* */ } return; } if ($f === undefined) { $f = { $blk: $b }; } $f.$ptr = $ptr; $f._r$1 = _r$1; $f._r$2 = _r$2; $f._r$3 = _r$3; $f._r$4 = _r$4; $f._r$5 = _r$5; $f._r$6 = _r$6; $f.$s = $s; $f.$r = $r; return $f;
...
//# sourceMappingURL=dashboardScript.js.map
